...
function IconGradio(props) {
  return (
    <svg width="2em" height="2em" viewBox="0 0 256 224" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
    <title>gradio</title>
    <defs>
