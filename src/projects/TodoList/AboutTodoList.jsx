...
export default function AboutTodoList() {
  ...
  return (
    <section id="about-container">
      ...
      <div className="flex flex-col xl:flex-row items-center gap-12 m-48 sm:mt-0 sm:gap-24">
