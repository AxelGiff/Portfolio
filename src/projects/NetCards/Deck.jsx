...
export default function Deck () {
  return (
    ...
    <img src={new URL("./images/netcards4.png", import.meta.url).href} width={1000} height={650} alt="screen todo list" loading="lazy" className="translate-x-1.5 flex justify-center items-center -z-[-10] sm:ml-24   shadow-lg  sm:visible [mask-image:linear-gradient(to_bottom,white,white,transparent)] transition duration-1000 rounded-xl" />
