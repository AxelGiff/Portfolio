...
export default function Others () {
  return (
    <div className='flex flex-col items-center justify-center sm:flex-row items-center gap-12 m-64 xl:m-48 sm:mt-0 sm:gap-24'>
              ...
              <img src={new URL("./images/sinscrire.png", import.meta.url).href} width={1100} height={650} alt="screen todo list" loading="lazy" className=" flex justify-center items-center -z-[-10] shadow-lg  sm:visible translate-x-1.5 [mask-image:linear-gradient(to_bottom,white,white,transparent)] transition duration-1000 rounded-xl" />
