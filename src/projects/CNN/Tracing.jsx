  ...
  const tabs = [
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-l md:text-4xl font-bold text-white bg-gradient-to-br from-[#1B3A6B] to-[#2C5282]">
          ...
          <img src={require("./images/auth.png")}  alt="screen todo list" loading="lazy"   className="object-contain object-top w-full -bottom-2  inset-x-0  rounded-xl mx-auto absolute h-auto rounded-xl mx-auto"
 ...
 />
    ...
    },
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-l md:text-4xl font-bold text-white bg-gradient-to-br from-[#1B3A6B] to-[#2C5282]">
          <p>2. Grid choice </p>
          <img src={require("./images/grille.png")}  alt="screen todo list" loading="lazy"   className="object-contain object-top w-full -bottom-2  inset-x-0  rounded-xl mx-auto absolute h-auto rounded-xl mx-auto"
 />
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-l md:text-4xl font-bold text-white bg-gradient-to-br from-[#1B3A6B] to-[#2C5282]">
          <p>3. Player list </p>
          <img src={require("./images/tiragesort.png")}  alt="screen todo list" loading="lazy"  className="object-contain object-top w-full -bottom-2  inset-x-0  rounded-xl mx-auto absolute h-auto rounded-xl mx-auto"
 />
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-l md:text-4xl font-bold text-white bg-gradient-to-br from-[#1B3A6B] to-[#2C5282]">
          <p>4. Draw</p>
          <img src={require("./images/tirage.png")}  alt="screen todo list" loading="lazy"   className="object-contain object-top w-full -bottom-2  inset-x-0  rounded-xl mx-auto absolute h-auto rounded-xl mx-auto"
 />
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-l md:text-4xl font-bold text-white bg-gradient-to-br from-[#1B3A6B] to-[#2C5282]">
          <p>5. Ranking</p>
          <img src={require("./images/classement.png")}  alt="screen todo list" loading="lazy"   className="object-contain object-top w-full -bottom-2  inset-x-0  rounded-xl mx-auto absolute h-auto rounded-xl mx-auto"
 />
        </div>
      ),
    },
