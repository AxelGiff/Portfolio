  ...
  return (
    ...
    <div className="flex mb-40 -mt-24 font-inter flex-col items-center justify-center h-screen z-10">
      <div class="gradient-cnn z-[-10000]  -top-1/4 w-full h-full opacity-30"></div>
        ...
        <p className="text-gradient-primary1 text-[1.2rem] font-bold relative right-2 mt-6">2025 | {t('Two months')} <br></br>  <TextShine text={t('Medic.ial (Chatbot)')} />{/* <h1 className="text-gradient-primary2 font-bold text-8xl ">Axel</h1> */}</p>
