...
export default function History() {
  return (
    ...
    <div className="flex flex-col items-center">
      <span>
        <img src={require("../src/images/icons8-paper-plane-50.png")} alt="plane" style={{ width: '30px', height: '30px', marginRight: '5px' }} />
      </span>
      <h3>Road Trip</h3>
    </div>
  ...
  <h4 className="mt-4">
    ...
    <span>
      <img src={require("../src/images/icons8-add-bookmark-64.png")} 
  ...
  <div className="grid grid-cols-2 gap-4 text-white text-xl ml-10 italic">
    ...
    <div className="timeline">
    <span class="bg-yellow-100 text-yellow-800 text-l rounded-xl font-medium me-2 px-2.5 py-1.5  dark:bg-yellow-900 m-2 dark:text-yellow-300">Professional Experience</span>

      
      <h4 class="mt-4">Full Stack developper Apprenticeship at Préfecture de Police de Paris <span><img src={require("../src/images/prefecture.png")} style={{ width: '25%', marginLeft: '10px', marginTop:'10px', marginBottom:'10px' }} alt="new"/></span></h4>
    ...
    <h4 class="mt-4">Internship at Level Up Tech Consulting <span><img src={require("../src/images/Capsule-244-×-244-px-244-×-100-px-3.png")} style={{ width: '25%', marginLeft: '10px' }} alt="actually"/></span></h4>
    ...
    <div className="timeline">
    <span class="bg-violet-100 text-violet-100 text-l rounded-xl font-medium me-2 px-2.5 py-1.5  dark:bg-violet-900 m-2 dark:text-violet-100">Academical Experience</span>
      <h4 class="mt-4">Destination : University <span><img src={require("../src/images/icons8-chapeau-de-diplôme-30.png")} style={{width: '5%', marginLeft: '10px'}} alt="univ"/></span></h4>
    ...
    <div className="timeline">
    <span class="bg-violet-100 text-violet-100 text-l rounded-xl font-medium me-2 px-2.5 py-1.5  dark:bg-violet-900 m-2 dark:text-violet-100">Academical Experience</span>
      <h4 class="mt-4">Destination : High school <span><img src={require("../src/images/icons8-école-50.png")} style={{width: '5%' , marginLeft: '10px'}} alt="student"/></span></h4>
      <h6>2018-2021</h6>
